...
<body>
    <?php
    include 'inc/carRental/carRental-nav.php';
    // include 'inc/section_popup.php';
      include "inc/carRental/carRental-mobile-section_popup.php";
  include 'inc/carRental/small_banner.php';
    include 'inc/home/feature.php';
    include 'inc/carRental/ride_types.php';
