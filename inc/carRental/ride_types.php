    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="item_wrapper">
          <div class="item">
            <div class="title">Rent Economy</div>
            <div
              class="bg"
              style="
                background-image: url('images/carRental/automobile-5022764_640.jpg');
              "
            ></div>
            <p>
              Affordable, reliable, and fuel-efficient. Great for everyday travel or quick errands around town.
            </p>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="item_wrapper">
          <div class="item">
            ...
            <div
              class="bg"
              style="background-image: url('images/carRental/Toyota-RAV4-Hybrid-036.webp')"
            ></div>
            <p>
