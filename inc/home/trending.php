                ...
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        <div class="tre_img"  style=" 
                          background-image: url('./images/home/view-luxurious-cruise-ship (1).jpg');"
            ...
            <div class="col-sm-4">
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        <div class="tre_img"
                        style=" 
                          background-image: url('./images/home/white-yacht-with-mountains.jpg');"
                        >
                            <div class="middle_dark_overlay"></div>
            ...
            <div class="col-sm-4">
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        ...
                        style=" 
                          background-image: url('./images/home/view-luxurious-cruise-ship.jpg');"
                        >
                            <div class="middle_dark_overlay"></div>
