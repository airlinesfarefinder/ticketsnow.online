    ...
    <div class="container">
        <div class="row">
            <div class="inspo_title">
                <h2>Affordable Car Rentals with Deals</h2>
            </div>
        </div>
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/home/young-couple-talking-sales-person-car-showroom.jpg');
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/home/handsome-elegant-black-man-car-salon.jpg');
                       clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%);
                    ">
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/home/sport-car-with-black-white-autotuning-driving-forest.jpg');
                        clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%);
                    ">
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/home/beautiful-natural-autumn-scene.jpg');
                       clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%);
                    ">
