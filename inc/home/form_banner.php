...
#banner {
  ...
  width: 100%;
  min-height: 650px;
  background: url("./images/images/3997404.jpg");
...
@keyframes slideBackground {
  0%, 33.32% {
    background-image: url('./images/home/transport-5207942_1280.jpg');
  }
  33.33%, 66.65% {
    background-image: url('./images/cruise/cruise-ship-108973_1280.jpg');
  }
  66.66%, 100% {
    background-image: url('./images/carRental/renault-6969346_1280.jpg');
  }
}
