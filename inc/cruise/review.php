...
<body>
    ...
    <div class="carousel-item active">
        <div class="testimonial-content">
            <div class="stars">★★★★★</div>
            <p>
               Booking my cruise with TicketSnowOnline was smooth, simple, and enjoyable from start to finish. They had so many cruise lines and destinations to choose from, and I easily found the perfect itinerary within my budget. I’ll definitely use them again for my next trip.
            </p>
    ...
    <div class="carousel-item">
        <div class="testimonial-content">
            <div class="stars">★★★★★</div>
            <p>
               TicketSnowOnline is now my go-to for cruises. The prices were lower than booking direct, and the variety of cruise options was impressive. I had a small issue while reserving, and their team helped right away with professionalism and care—such great service!
            </p>
