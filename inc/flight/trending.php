    ...
    <div class="container">
        ...
        <div class="row">
            <div class="trending_title">
                <h2>Don't miss these trending holiday flight deals</h2>
            </div>
        </div>
                ...
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        <div class="tre_img"  style=" 
                          background-image: url('./images/flight/travelers-with-baggage-street.jpg');"
            ...
            <div class="col-sm-4">
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        <div class="tre_img"
                        style=" 
                          background-image: url('./images/flight/beautiful-natural-autumn-scene.jpg');"
                        > 
                            <div class="middle_dark_overlay"></div>
            ...
            <div class="col-sm-4">
                <div class="trending_item_container">
                    <div class="tre_img_wrap">
                        ...
                        style=" 
                          background-image: url('./images/flight/travel-suitcase-hand.jpg');"
                        >
                            <div class="middle_dark_overlay"></div>
