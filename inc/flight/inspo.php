...
<div id="inspo">
    <div class="container">
        ...
        <div class="row" style="margin-bottom:20px;">
            <div class="col-sm-6">
                <div class="inspo_item">
                    <div class="inspo_info">
                        <h3>Hot right now</h3>
                        <p>Hot right now
                            Discover some of our most in demand holiday destinations</p>

                        <a href="tel:(888) 497-2660"> <button>Discover destinations</button></a>
                    </div>

                    <div class="inspo_img"

                        style=" 
                     background-image: url('./images/flight/sunrise.jpg');
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    <div class="inspo_info">
                        ...
                        <a href="tel:(888) 497-2660"> <button>Take quiz</button></a>
                    </div>

                    <div class="inspo_img"

                        style=" 
                     background-image: url('./images/images/small-house-built-peaceful-green-hill-high-up-mountains.jpg');
                       clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%);
                    ">
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/flight/road-5089188_640.jpg');
                        clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%);
                    ">
            ...
            <div class="col-sm-6">
                <div class="inspo_item">
                    ...
                    <div class="inspo_img"
                        ...
                        style=" 
                     background-image: url('./images/flight/globe-7939725_640.jpg');
                       clip-path: polygon(0 100%, 20% 0, 100% 0, 100% 100%);
                    ">
